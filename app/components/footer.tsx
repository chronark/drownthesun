  ...
  return (
    <footer className="">
      <div className="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {navigation.social.map((item) => (
            <Link
              ...
              href={item.href}
              target="_blank"
              className="text-carbon-600 hover:text-carbon-300 duration-200"
            >
        ...
        <p className="mt-10 text-center text-xs leading-5 text-carbon-500">
          &copy; {new Date().getUTCFullYear()} Drown the Sun. All rights reserved.
        </p>
      </div>
    </footer>
  );
