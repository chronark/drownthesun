    ...
    return (
        <Layout>
            ...
            <footer className="text-carbon-400">
                <div className="flex flex-col items-center justify-between px-5 py-8 mx-auto sm:flex-row">
                    <span className="mt-4 text-sm text-carbon-500 sm:py-2 sm:mt-0">© 2020 Drown The Sun</span>
