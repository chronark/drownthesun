...
const Home: NextPage<Props> = ({ concerts }) => {
                                ...
                                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                    <div className="rounded-sm ">
                                        <a
                                            ...
                                            className="flex items-center justify-center w-full px-8 py-3 text-base font-medium leading-6 transition duration-150 ease-in-out border border-transparent shadow text-carbon-900 bg-carbon-50 hover:text-black hover:shadow-glow hover:bg-white focus:outline-none focus:shadow-outline focus:border-red-300 md:py-4 md:text-lg md:px-10"
                                            target="blank"
                                        >
                                            Listen
                                        </a>
  ...
  <div className="flex flex-col items-center justify-between px-5 py-8 mx-auto space-y-2 sm:space-y-0 sm:flex-row">
    <span className="mt-4 text-sm text-carbon-500 sm:py-2 sm:mt-0">© 2020 Drown The Sun
    </span>
    <div className="flex items-center space-x-6 text-carbon-600">
            ...
            <a className="w-5 h-5 fill-current hover:text-carbon-300" target="blank" href="https://www.instagram.com/drown_the_sun/?hl=de">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a className="w-5 h-5 fill-current hover:text-carbon-300" target="blank" href="https://open.spotify.com/artist/2yFB2TDFWStvT5nYj8g8Hc?si=ODHYkTPrTeCUb0Scrimzwg">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z" />
                </svg>
            </a>
            <a className="w-5 h-5 fill-current hover:text-carbon-300" target="blank" href="https://www.youtube.com/channel/UCLhT0cRde-LP89Va_jON7fA">
